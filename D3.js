...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  const valueeyeColor = character.eye_color;

  switch (valueeyeColor) {
    case "blue":
...
for (let i = 0; i < femaleCharacters.length; i++) {
  const femaleCharacterName = femaleCharacters[i];
  const index = characters.indexOf(femaleCharacterName);
...
const character = starWarsCharacters[random];
